...
- [x] 答案、提示、积分、掌握度和人工复核单通过 `effect_key` 幂等。
- [x] 三级提示后进入人工复核前置，不自动下调掌握度。
...
- [x] 21 个测试文件 / 170 个用例、前后端构建和前端检查通过。

**当前状态：** 🟢 核心状态机、故障证据、响应式回归与性能基线已补齐，提交审核。
...
- 阶段 4：核心状态机、故障证据、响应式回归与性能基线已补齐，提交审核
